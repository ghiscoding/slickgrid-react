...
export interface CreatedView extends ReactComponentOutput {
  id: string | number;
  dataContext: any;
}
...
export class RowDetailViewExtension implements UniversalRowDetailViewExtension {
  ...
  /** Dispose of all the opened Row Detail Panels React View Slots */
  disposeAllViewSlot() {
    ...
    if (columnDefinitions && gridOptions) {
      ...
      if (gridOptions && gridOptions.rowDetailView) {
        if (!this._addon) {
          ...
          // load the Preload & RowDetail Templates (could be straight HTML or React View/ViewModel)
          // when those are React View/ViewModel, we need to create View Slot & provide the html containers to the Plugin (preTemplate/postTemplate methods)
