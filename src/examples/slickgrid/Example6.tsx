...
class Example6 extends React.Component<Props, State> {
  ...
  <br/>Take a look at the (<a href="https://github.com/slickgrid-universal/slickgrid-react/wiki/GraphQL" target="_blank">Wiki docs</a>)
    <ul class="small">
      ...
      <div id="demo-container" className="container-fluid">
        <h2>
          ...
          <span className="float-end font18">
            see&nbsp;
            <a target="_blank"
              href="https://github.com/slickgrid-universal/slickgrid-react/blob/master/src/examples/slickgrid/Example6.tsx">
