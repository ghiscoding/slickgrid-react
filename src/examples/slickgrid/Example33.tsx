...
export default class Example32 extends React.Component<Props, State> {
  ...
  subTitle = `
  This demo shows how to create Regular & Custom Tooltips (<a href="https://github.com/slickgrid-club/slickgrid-react/wiki/Custom-Tooltip-(plugin)" target="_blank">Wiki docs</a>)
  <br/>
  <ul class="small">
      ...
      <div id="demo-container" className="container-fluid">
        <h2>
          ...
          <span className="float-end font18">
            see&nbsp;
            <a target="_blank"
              href="https://github.com/slickgrid-club/slickgrid-react/blob/master/src/examples/slickgrid/Example33.tsx">
