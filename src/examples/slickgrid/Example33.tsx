...
export default class Example32 extends React.Component<Props, State> {
  ...
  subTitle = `
  This demo shows how to create Regular & Custom Tooltips (<a href="https://github.com/ghiscoding/slickgrid-react/wiki/Custom-Tooltip-(plugin)" target="_blank">Wiki docs</a>)
  <br/>
  <ul class="small">
