...
class Example9 extends React.Component<Props, State> {
  ...
  subTitle = `
    ...
    (<a href="https://github.com/slickclub/slickgrid-react/wiki/Grid-Menu" target="_blank">Wiki docs</a>)
    <ul>
      ...
      <div id="demo-container" className="container-fluid">
        <h2>
          ...
          <span className="float-end font18">
            see&nbsp;
            <a target="_blank"
              href="https://github.com/slickclub/slickgrid-react/blob/master/src/examples/slickgrid/Example9.tsx">
