...
export default class Example4 extends React.Component<Props, State> {
  ...
  subTitle = `
  Sort/Filter on client side only using SlickGrid DataView (<a href="https://github.com/slickgrid-stellar/slickgrid-react/wiki/Sorting" target="_blank">Wiki docs</a>)
  <br/>
  <ul class="small">
    ...
    <li>Custom Filter are now possible, "Description" column below, is a customized InputFilter with different placeholder. See <a href="https://github.com/slickgrid-stellar/slickgrid-react/wiki/Custom-Filter" target="_blank">Wiki - Custom Filter</a></li>
  </ul>
`;
      ...
      <div id="demo-container" className="container-fluid">
        <h2>
          ...
          <span className="float-end font18">
            see&nbsp;
            <a target="_blank"
              href="https://github.com/slickgrid-stellar/slickgrid-react/blob/master/src/examples/slickgrid/Example4.tsx">
