...
export default class Example13 extends React.Component<Props, State> {
  ...
  subTitle = `
    <ul>
      <li><a href="https://github.com/slickgrid-club/slickgrid-react/wiki/Grouping-&-Aggregators" target="_blank">Wiki docs</a></li>
      ...
      <div id="demo-container" className="container-fluid">
        <h2>
          ...
          <span className="float-end font18">
            see&nbsp;
            <a target="_blank"
              href="https://github.com/slickgrid-club/slickgrid-react/blob/master/src/examples/slickgrid/Example13.tsx">
