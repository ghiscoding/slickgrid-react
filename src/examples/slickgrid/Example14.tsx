...
export default class Example14 extends React.Component {
  ...
  <ul>
    <li>
      Row Colspan - (<a href="https://github.com/slickgrid-universal/slickgrid-react/wiki/Row-Colspan" target="_blank">Wiki docs</a>) /
      Header Grouping - (<a href="https://github.com/slickgrid-universal/slickgrid-react/wiki/Header-Title-Grouping" target="_blank">Wiki docs</a>)
    </li>
      ...
      <div id="demo-container" className="container-fluid">
        <h2>
          ...
          <span className="float-end font18">
            see&nbsp;
            <a target="_blank"
              href="https://github.com/slickgrid-universal/slickgrid-react/blob/master/src/examples/slickgrid/Example14.tsx">
