...
export default class Example3 extends React.Component<Props, State> {
  ...
  subTitle = `
  Grid with Inline Editors and onCellClick actions (<a href='https://github.com/slickgrid-stellar/slickgrid-react/wiki/Editors' target='_blank'>Wiki docs</a>).
  <ul>
      ...
      <div id='demo-container' className='container-fluid'>
        <h2>
          ...
          <span className="float-end font18">
            see&nbsp;
            <a target="_blank"
              href="https://github.com/slickgrid-stellar/slickgrid-react/blob/master/src/examples/slickgrid/Example3.tsx">
