...
export default class Example25 extends React.Component<Props, State> {
  ...
  subTitle = `
  Use basic GraphQL query with any external public APIs (<a href="https://github.com/slickgrid-universal/slickgrid-react/wiki/GraphQL" target="_blank">Wiki docs</a>).
  <ul>
      ...
      <div id="demo-container" className="container-fluid">
        <h2>
          ...
          <span className="float-end font18">
            see&nbsp;
            <a target="_blank"
              href="https://github.com/slickgrid-universal/slickgrid-react/blob/master/src/examples/slickgrid/Example25.tsx">
