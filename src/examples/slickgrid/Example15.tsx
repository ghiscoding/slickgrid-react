...
class Example15 extends React.Component<Props, State> {
  ...
  subTitle = `
  Grid State & Preset (<a href="https://github.com/slickgrid-universal/slickgrid-react/wiki/Grid-State-&-Preset" target="_blank">Wiki docs</a>)
  <br/>
  <ul class="small">
      ...
      <div id="demo-container" className="container-fluid">
        <h2>
          ...
          <span className="float-end font18">
            see&nbsp;
            <a target="_blank"
              href="https://github.com/slickgrid-universal/slickgrid-react/blob/master/src/examples/slickgrid/Example15.tsx">
