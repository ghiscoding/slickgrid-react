...
export default class Example7 extends React.Component<Props, State> {
  ...
  subTitle = `
    ...
    (<a href="https://github.com/slickgrid-club/slickgrid-react/wiki/Header-Menu-&-Header-Buttons" target="_blank">Wiki docs</a>)
    <ul>
      ...
      <div id="demo-container" className="container-fluid">
        <h2>
          ...
          <span className="float-end font18">
            see&nbsp;
            <a target="_blank"
              href="https://github.com/slickgrid-club/slickgrid-react/blob/master/src/examples/slickgrid/Example7.tsx">
