...
class Example12 extends React.Component<Props, State> {
  ...
  subTitle = `Support multiple locales with the i18next plugin, following these steps.
    Take a look at the (<a href="https://github.com/slickclub/slickgrid-react/wiki/Localization" target="_blank">Wiki documentation</a>)
    <ol class="small">
      ...
      <li>For the Select (dropdown) filter, you can fill in the "labelKey" property, if found it will use it, else it will use "label"</li>
        <ul>
          ...
          <li>More info on the Select Filter <a href="https://github.com/slickclub/slickgrid-react/wiki/Select-Filter" target="_blank">Wiki page</a>
        </ul>
        <li>For more info about "Download to File", read the <a href="https://github.com/slickclub/slickgrid-react/wiki/Export-to-File" target="_blank">Wiki page</a></li>
      </ol>
    `;
      ...
      <div id="demo-container" className="container-fluid">
        <h2>
          ...
          <span className="float-end font18">
            see&nbsp;
            <a target="_blank"
              href="https://github.com/slickclub/slickgrid-react/blob/master/src/examples/slickgrid/Example12.tsx">
