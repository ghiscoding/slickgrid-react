...
const Example12: React.FC = () => {
  ...
  function dynamicallyAddTitleHeader() {
    ...
    const newCol = { id: `title${duplicateTitleHeaderCount++}`, field: 'id', nameKey: 'TITLE', formatter: taskTranslateFormatter, sortable: true, minWidth: 100, filterable: true, params: { useFormatterOuputToFilter: true } };
    ...
    <div id="demo-container" className="container-fluid">
      ...
      <div className="subtitle">
        ...
        <ol className="small">
          ...
          <ul>
            <li>What if your select options have totally different value/label pair? In this case, you can use the <b>customStructure: <code>&#123;label: 'customLabel', value: 'customValue'&#125;</code></b> to change the property name(s) to use.'</li>
