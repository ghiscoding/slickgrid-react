...
export default class Example20 extends React.Component<Props, State> {
  ...
  subTitle = `
    This example demonstrates the use of Pinned (aka frozen) Columns and/or Rows (<a href="https://github.com/slickclub/slickgrid-react/wiki/Pinned-(aka-Frozen)-Columns-Rows" target="_blank">Wiki docs</a>)
    <ul>
      ...
      <div id="demo-container" className="container-fluid">
        <h2>
          ...
          <span className="float-end font18">
            see&nbsp;
            <a target="_blank"
              href="https://github.com/slickclub/slickgrid-react/blob/master/src/examples/slickgrid/Example20.tsx">
