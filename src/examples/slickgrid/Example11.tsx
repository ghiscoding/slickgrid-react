...
export default class Example11 extends React.Component {
  ...
  subTitle = `
  Add / Update / Hightlight an Item from the Datagrid (<a href="https://github.com/slickclub/slickgrid-react/wiki/Add,-Update-or-Highlight-a-Datagrid-Item" target="_blank">Wiki docs</a>).
  <ul>
    ...
    <li>You can change the highlighted color &amp; animation by changing the <a href="https://github.com/slickclub/slickgrid-react/blob/master/slickgrid-react/src/slickgrid-react/styles/_variables.scss" target="_blank">SASS Variables</a></li>
    <ul>
    ...
    <ul>
      <li>Example, click on button "Highlight Rows with Duration over 50" to see row styling changing. <a href="https://github.com/slickclub/slickgrid-react/wiki/Dynamically-Add-CSS-Classes-to-Item-Rows" target="_blank">Wiki doc</a></li>
    </ul>
  </ul>
  `;
      ...
      <div id="demo-container" className="container-fluid">
        <h2>
          ...
          <span className="float-end font18">
            see&nbsp;
            <a target="_blank"
              href="https://github.com/slickclub/slickgrid-react/blob/master/src/examples/slickgrid/Example11.tsx">
