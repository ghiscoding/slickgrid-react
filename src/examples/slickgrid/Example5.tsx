...
export default class Example5 extends React.Component<Props, State> {
  ...
  subTitle = `
    ...
    Take a look at the (<a href="https://github.com/slickgrid-stellar/slickgrid-react/wiki/OData" target="_blank">Wiki documentation</a>)
    <br/>
    <ul class="small">
      ...
      <li>You can also preload a grid with certain "presets" like Filters / Sorters / Pagination <a href="https://github.com/slickgrid-stellar/slickgrid-react/wiki/Grid-State-&-Preset" target="_blank">Wiki - Grid Preset</a>
      ...
      <div id="demo-container" className="container-fluid">
        <h2>
          ...
          <span className="float-end font18">
            see&nbsp;
            <a target="_blank"
              href="https://github.com/slickgrid-stellar/slickgrid-react/blob/master/src/examples/slickgrid/Example5.tsx">
