...
class Example23 extends React.Component<Props, State> {
  ...
  subTitle = `
    This demo shows how to use Filters with Range of Search Values (<a href="https://github.com/slickgrid-club/slickgrid-react/wiki/Range-Filters" target="_blank">Wiki docs</a>)
    <br/>
    <ul class="small">
      ...
      <div id="demo-container" className="container-fluid">
        <h2>
          ...
          <span className="float-end font18">
            see&nbsp;
            <a target="_blank"
              href="https://github.com/slickgrid-club/slickgrid-react/blob/master/src/examples/slickgrid/Example23.tsx">
