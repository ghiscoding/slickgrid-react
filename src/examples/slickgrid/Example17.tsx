...
export default class Example17 extends React.Component {
  ...
  subTitle = `
    ...
    <ul>
      ...
      <li>
        Soure code for this example is available <a href="https://github.com/slickgrid-stellar/slickgrid-react/blob/master/doc/github-demo/src/examples/slickgrid/example17.tsx" target="_blank">here</a>
      </li>
    </ul>
  `;
      ...
      <div id="demo-container" className="container-fluid">
        <h2>
          ...
          <span className="float-end font18">
            see&nbsp;
            <a target="_blank"
              href="https://github.com/slickgrid-stellar/slickgrid-react/blob/master/src/examples/slickgrid/Example17.tsx">
