...
export default class Example30 extends React.Component<Props, State> {
  ...
  <br>The modal is simply populated by looping through your column definition list and also uses a lot of the same logic as inline editing (see <a href="https://github.com/slickgrid-stellar/slickgrid-react/wiki/Composite-Editor-Modal" target="_blank">Composite Editor - Wiki</a>.)`;
      ...
      <div id="demo-container" className="container-fluid">
        <h2>
          ...
          <span className="float-end font18">
            see&nbsp;
            <a target="_blank"
              href="https://github.com/slickgrid-stellar/slickgrid-react/blob/master/src/examples/slickgrid/Example30.tsx">
