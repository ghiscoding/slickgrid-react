...
export default class Example10 extends React.Component<Props, State> {
  ...
  subTitle = `
    Row selection, single or multi-select (<a href="https://github.com/slickgrid-club/slickgrid-react/wiki/Row-Selection" target="_blank">Wiki docs</a>).
    <ul>
      ...
      <div id="demo-container" className="container-fluid">
        <h2>
          ...
          <span className="float-end font18">
            see&nbsp;
            <a target="_blank"
              href="https://github.com/slickgrid-club/slickgrid-react/blob/master/src/examples/slickgrid/Example10.tsx">
