...
export default class Example18 extends React.Component<Props, State> {
  ...
  subTitle = `
  <ul>
    <li>This example shows 3 ways of grouping <a href="https://github.com/slickclub/slickgrid-react/wiki/Grouping-&-Aggregators" target="_blank">Wiki docs</a></li>
    <ol>
      ...
      <div id="demo-container" className="container-fluid">
        <h2>
          ...
          <span className="float-end font18">
            see&nbsp;
            <a target="_blank"
              href="https://github.com/slickclub/slickgrid-react/blob/master/src/examples/slickgrid/Example18.tsx">
