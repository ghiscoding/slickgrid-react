...
#### Usage
To use any of them, you need to import `Formatters` from `slickgrid-react` and add a `formatter: ...` in your column definitions as shown below:
```tsx
...
## UI Sample
![Default Slickgrid Example](https://github.com/ghiscoding/slickgrid-react/blob/master/screenshots/formatters.png)
